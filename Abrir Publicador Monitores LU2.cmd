...
echo.
start "Publicador Monitores LU2 Exteriores" "%PANEL_CLOUD_URL%/publisher.html?token=%BRIDGE_SECRET%&channel=lu2&name=LU2%%20Exteriores&fps=20&previewDevice=vMix%%20Video%%20External%%202&programDevice=vMix%%20Video"
